...
func == (lhs: FormModelLevel, rhs: FormModelLevel) -> Bool {
  switch (lhs, rhs) {
  case (.root, .root):
    return true
...
func == (lhs: RowSettings.ValidationState, rhs: RowSettings.ValidationState) -> Bool {
  switch (lhs, rhs) {
  case (.valid, .valid):
    return true
  case (.failed, .failed):
...
extension RowSettings.ValidationState {
